        ...
        await editable.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("Original Link", url=share_link),
                 ...
                 [InlineKeyboardButton("Bots Channel", url="https://t.me/tmm_heroku_world"),
                  InlineKeyboardButton("Support Group", url="https://t.me/Tmm_support_chat")]]
            ),
            disable_web_page_preview=True
        )
        await bot.send_message(
...
async def save_media_in_channel(bot: Client, editable: Message, message: Message):
    try:
        ...
        await forwarded_msg.reply_text(
            ...
            disable_web_page_preview=True)
        share_link = f"https://telegram.me/{Config.BOT_USERNAME}?start=tmm_heroku_world_{str_to_b64(file_er_id)}"
        short_link = get_short(share_link)
        await editable.edit(
